...
# Практика
В каждом конспекте будет ссылка на соответсвующий набор задач на сайте Codeforces. Чтобы начать решать задачи нужно сначала вступить в [группу](https://codeforces.com/group/eYghlTf5Xb/contests).
";      
